/**
 * Excellus - Internacionalização PT/EN
 */
...
const translations = {
  pt: {
    ...
    testimonials: {
      ...
      quote3: '"Reforma completa da casa. Prazo cumprido, orçamento respeitado. Excelência em tudo."',
      quote4: '"Atendimento impecável do início ao fim. Nossa suíte ficou digna de hotel cinco estrelas."',
      quote5: '"A área gourmet que sempre sonhamos. Qualidade dos materiais e acabamento perfeito."',
    },
    gallery: {
      label: 'Portfólio',
    ...
    form: {
      ...
      projectResidential: 'Residencial',
      projectCommercial: 'Comercial',
      projectInterior: 'Interiores',
      projectExterior: 'Exteriores',
      projectOther: 'Outro',
    ...
    footer: {
      ...
      services: 'Reformas • Pisos • Acabamentos',
      ...
      subscribe: 'Inscrever',
      rights: '© 2025 Excellus Group. Todos os direitos reservados.',
      privacy: 'Privacidade',
      terms: 'Termos',
    },
  },
  en: {
    ...
    testimonials: {
      ...
      quote3: '"Complete home renovation. Deadline met, budget respected. Excellence in everything."',
      quote4: '"Impeccable service from start to finish. Our suite looks like a five-star hotel."',
      quote5: '"The gourmet area we always dreamed of. Material quality and perfect finishing."',
    },
    gallery: {
      label: 'Portfolio',
...
>>>>>>> da0621564364c05a76e41f9c2ff0c74c9399d7ca
    ...
    form: {
      ...
      projectResidential: 'Residential',
      projectCommercial: 'Commercial',
      projectInterior: 'Interiors',
      projectExterior: 'Exteriors',
      projectOther: 'Other',
    ...
    footer: {
      ...
      services: 'Remodeling • Flooring • Finishing',
      ...
      subscribe: 'Subscribe',
      rights: '© 2025 Excellus Group. All rights reserved.',
      privacy: 'Privacy',
      terms: 'Terms',
    },
  },
...
>>>>>>> da0621564364c05a76e41f9c2ff0c74c9399d7ca
  ...
  if (formType) {
    formType.innerHTML = `
      ...
      <option value="residential">${t.form.projectResidential}</option>
      <option value="commercial">${t.form.projectCommercial}</option>
      <option value="interior">${t.form.projectInterior}</option>
      <option value="exterior">${t.form.projectExterior}</option>
